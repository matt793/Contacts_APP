...
class Ui_Contacts(object):
    def setupUi(self, Contacts):
        ...
        self.Last_lable.setGeometry(QtCore.QRect(10, 70, 71, 20))
    ...
    def retranslateUi(self, Contacts):
        ...
        Contacts.setWindowTitle(_translate("Contacts", "Dialog"))
